...
I'm a **Data Analyst** based in Nairobi, Kenya — I turn messy, real-world data 
into clear findings and actionable business decisions.

My work spans the full analytics pipeline: cleaning raw datasets, writing SQL queries, 
building star-schema databases, running exploratory analysis in Python, and publishing 
interactive dashboards in Power BI. I care about making data understandable — 
not just to analysts, but to the business people who act on it.
...
### 📉 [Customer Churn Analysis — Telco Dataset](https://github.com/peter-ngamau/Telco-Customer-Churn-Analysis)
...
- 🌐 Portfolio: [peter-ngamau.github.io](https://peter-ngamau.github.io)
- 💼 LinkedIn: [linkedin.com/in/peter-ngamau](https://linkedin.com/in/peter-ngamau)
